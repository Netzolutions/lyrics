...
if (TYPO3_MODE === 'BE') {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        array(
            'access' => 'user,group',
            'icon' => 'EXT:' . $_EXTKEY . '/Resources/Public/Icons/module_group.png',
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        'Netzcript.' . $_EXTKEY,
        'lyrics',     // Make module a submodule of 'web'
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        array(
            'access' => 'user,group',
            'icon' => 'EXT:' . $_EXTKEY . '/Resources/Public/Icons/module_artist.png',
...
$GLOBALS['TCA']['tx_lyrics_domain_model_lyrics'] = array(
    'ctrl' => array(
        ...
        'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Configuration/TCA/Lyric.php',
...
$GLOBALS['TCA']['tx_lyrics_domain_model_artists'] = array(
    'ctrl' => array(
        ...
        'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Configuration/TCA/Artist.php',
