...
$GLOBALS['TCA']['tx_lyrics_domain_model_lyrics'] = array(
    ...
    'interface' => array(
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, text, vlabel, author, composer, time, has_translation, translated_title, translated_text, translator, artist',
    ),
    'types' => array(
